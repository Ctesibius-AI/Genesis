...
from genesys.doctor import doctor_deadman, doctor_requeue
from genesys.hooks.wiring import hook_wiring_status, write_hook_wiring
...
def main(argv: list[str] | None = None) -> int:
    ...
    p_wire.add_argument("--command", required=True,
                        help="the genesys.hooks.cli hook command to register")
