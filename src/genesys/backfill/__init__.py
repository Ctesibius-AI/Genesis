"""genesys.backfill — batch backfill injection door.

A THIN DRIVER over the existing capture pipeline (genesys.hooks.adapter.dispatch).
...
only enqueues; the drain (genesys.extraction.live.run_once) is a separate step.
"""
