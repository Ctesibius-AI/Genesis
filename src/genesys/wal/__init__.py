"""Genesys WAL — rolling append-only capture record (spec §2.1, DR-24 revised, DR-37).
...
Genesys-owned and PERMANENT (CS1): NOT subject to the harness's 30-day transcript cleanup;
