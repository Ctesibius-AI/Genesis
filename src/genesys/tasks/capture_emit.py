...
The DR-37 capture-mirror (``genesys.capture.mirror``) surfaces first-class
...
from genesys.capture.mirror import CaptureResult
from genesys.tasks.emit import record_created, record_done
...
def emit_task_events_from_capture(
    ...
    *,
    ...
    Args:
        data_root: Genesys data root (the tasks event log lives under ``tasks/``).
