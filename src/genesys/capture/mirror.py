...
already-parsed events (from fixtures). See ``genesys.capture.cli``.
"""
...
from genesys.scrub.scrubber import ScrubMatch, path_is_sensitive, scrub_text
...
# Event "type" values Genesys recognizes. These map onto the harness transcript /
