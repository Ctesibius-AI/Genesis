"""Graphiti client surface Genesis uses (spec §4.9a, F-GENESIS-11, DR-35).
...
window, and mutate native temporal fields + custom Genesis attributes. `FakeGraphitiClient`
is the in-memory stand-in that lets the whole adapter be tested offline. `CommitMarker` issues
the Genesis-controlled window boundary (§8.1 QA #6) that binds attribution to this writer's
...
class CommitMarker:
    """Genesis-issued monotonic commit boundary (§8.1 QA #6 hardening)."""
